...
bun run harness --real "<prompt>" # the same turn against real E2B + real Claude; this spends money
bun run harness --real --platform=bedrock "<prompt>"  # same models, billed to AWS instead
